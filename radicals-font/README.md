...
Also included are PDF and CSV files which show the radicals present in the font, their encodings, stroke numbers, meanings, readings and positions. A PNG image illustrates the 60 custom glyphs added by us. It can be [viewed in use on the _Kanji alive_ website](http://kanjialive.com/214-traditional-kanji-radicals/). _Japanese Radicals_ is freely available for private or commercial use under an Apache 2.0 license granted by Adobe. Please ensure that this license is included with the font should you wish to redistribute it.
